// Ported verbatim from src/components/opinions/aboutMe.ts — the testimonial set used on the
// landing page (a separate, smaller set from the one used on the Treatments page, see
// testimonials-treatments.ts).
