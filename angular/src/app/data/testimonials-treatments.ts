// Ported verbatim from src/components/opinions/opinions.ts — the testimonial set used on the
// Treatments page (a separate, larger set from the one used on the landing page, see
// testimonials-landing.ts).

import { Testimonial } from './testimonial';

export const treatmentsTestimonials: Testimonial[] = [
  {
    author: "M. Marina",
