// Therapy catalogue — ported verbatim from the React app's
// src/components/therapies/therapies.ts. Hungarian copy and inline <strong> markup
// are the product; do not translate or reword. `long` uses \n paragraph breaks and
// "- " bullet lines, rendered downstream.
...
export const THERAPIES: Therapy[] = [
  ...
  },
  {
    ...
    long:
      'Az <strong>FDM</strong> egy <strong>manuális</strong> (kézzel végzett) terápia, amely a <strong>fascia</strong>, azaz a kötőszöveti struktúrák problémáira összpontosít. A kezelést a páciens fájdalomképe, testbeszéde alapján végzem, és a célja a <strong>gyors és hatékony fájdalomcsillapítás.</strong>\n' +
  ...
  },
  {
    ...
    long:
      'A <strong>nervus vagus</strong> (magyarul a <strong>bolygóideg</strong>) a 10. agyidegünk, ami kilép a koponyánkból, és beidegzi a belső szerveink nagy részét.\n' +
  ...
  },
  {
    ...
    long:
      'A <strong>Mulligan manuálterápia</strong> az ízületek mobilizálására fókuszáló kezelés, mely során hatást gyakorlok az érintett ízületre, miközben a páciens aktív mozgást végez. Célja, hogy a korábban <strong>fájdalmas ízületi mozgás</strong> a külső hatás következtében <strong>fájdalommentessé váljon</strong> már az <strong>első ismétlés alatt</strong>.\n' +
  ...
  },
  {
    id: 'dorn_terapia',
    title: 'Dorn terápia',
    imageId: 'Dorn_terápia__cekv1u',
    short: 'Holisztikus szemléletű ízületi korrekciós technika',
    long:
      'A <strong>Dorn terápia</strong> egy manuálisan végzett <strong>ízületi korrekciós</strong> technika, melynek célja a fiziológiás helyzetek visszaállítása a <strong>végtag-</strong>, és <strong>gerincízületekben</strong>.\n' +
  ...
  },
  {
    ...
    imageId: 'Nyirok_kezelés__eogcem',
    short: 'A nyirokkeringés támogatása komplex megközelítéssel',
    long:
      'A <strong>nyirokrendszer</strong> meghatározó szerepet tölt be az <strong>immunrendszer</strong> működésében. A nyirokfolyadék tápanyagokkal és oxigénnel látja el a sejteket és ha a keringésben zavar keletkezik, akkor a szervezetben felhalmozódnak a toxinok és más káros anyagok.\n' +
  ...
  },
  {
    id: 'hegkezeles',
    title: 'Hegkezelés',
    imageId: 'Hegkezelés__wbj806',
    short: 'A hegek mobilizálása/oldása manuális technikákkal és eszközökkel',
    long:
      '<strong>Sérülések</strong> és <strong>műtétek</strong> után létrejött <strong>hegek</strong> nem csak a bőrfelszínen húzódnak, hanem <strong>mélyen</strong> a szövetek közé is lenyúlhatnak. Műtéti metszés során <strong>több réteg kötőszövet és izomszövet</strong> kerülhet átvágásra, ami hegesedéssel gyógyul.\n' +
  ...
  },
  {
    id: 'kopoly',
    title: 'Köpöly',
    imageId: 'Köpöly_tnfza9',
    short: 'Szövetlazítás és fájdalomcsillapítás vákuumos szívóhatás segítségével',
    long:
      'A <strong>köpöly</strong> terápia során <strong>vákuumot</strong> hozok létre a bőrön egy üveg- vagy szilikon köpöly segítségével, melynek <strong>vérkeringés fokozó</strong> és <strong>szövetlazító</strong> hatása van.\n' +
  ...
  },
  {
    ...
    short:
      'Színes tapaszok izomlazításra, ízület stabilizálásra, keringés serkentésére, és fájdalomcsillapításra',
    long:
      'A <strong>kineziológiai tapasz</strong> egy rugalmas pamutanyagból készült, <strong>gyógyszermentes</strong>, bőrre ragasztható szalag, amely segítségével a <strong>fájdalom</strong> és a <strong>mozgáskorlátozottság</strong> rövid időn belül csökkenthető.\n' +
  ...
  },
  {
    ...
    imageId: 'Állkapocs-ízületi_terápia__qcwsbl',
    short: 'A rágóízület és a környező izmok manuális kezelése',
    long:
      'Az <strong>állkapocs-ízületi terápia</strong> során az ízület körüli izmokat (pl. rágóizmot) <strong>lazító</strong>, és az ízületet <strong>mobilizáló</strong> manuális fogásokat alkalmazok. Bizonyos izmokat csak a szájnyíláson keresztül lehet elérni, így szükség esetén steril gumikesztyűt használva a szájon belüli izmokat is kezelem.\n' +
