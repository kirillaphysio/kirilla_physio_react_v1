    ...
    return (
      ...
      tartásjavító torna, tartásjavítás, gerincferdülés, stresszkezelés, bolygóideg"/>
            ...
            <meta property="og:description"
                  content="Kirilla Réka gyógytornász-fizioterapeuta honlapjának honlapjának kapcsolat oldala, ahol tájékozódhatsz Réka elérhetőségeiről."/>
                ...
                <div className="contacts-wrapper">
                    <div className="link-container">
                        ...
                        {!isMobile && <iframe title="Google maps"
                                              ...
                                              width="100%" height="450" style={{border: 0}} allowFullScreen={true}
                                              loading="lazy"
                                              referrerPolicy="no-referrer-when-downgrade"></iframe>}
                    </div>
                    <div className="link-container"><a href={"mailto: kirillaphysio@gmail.com"}><FontAwesomeIcon
                        icon={faEnvelope}/>Ha
